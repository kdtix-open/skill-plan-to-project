...
def _safe_extract_zip(zip_file: zipfile.ZipFile, dest_dir: str) -> None:
    ...
    for info in zip_file.infolist():
        # Reject symlinks: Unix mode bits 0o120000 indicate a symlink entry.
        # A symlink stored at a valid path can still resolve outside dest_dir
        # after extraction, so we must block them entirely.
        if (info.external_attr >> 16) & 0o170000 == 0o120000:
            raise InstallError("Archive contains symlinks which are not permitted.")
